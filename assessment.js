...
// 				if(snake[key].letter.charAt(0) === 's'){
// 				return str.replaceAt(0, "s");
// 				}
//     }
...
function removeItem(array, removeItem) {
  	var i = array.indexOf(removeItem);
 	if(i !== -1){
 	array.splice(i, 1);
 	}
 		return array;
...
function getValueOfProperty(object, key){
}
